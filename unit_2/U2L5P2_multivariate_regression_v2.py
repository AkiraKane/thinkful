...
# home_ownership - handle as a categorical variable
# int_rate - scrubbed to a decimal
...
# Changed from v1: let's use all three values
homeowner = loan_data['owns']

# compute percentage of owns vs rents:
X = loan_data.copy()
y = loan_data.pop('approved')
